-- AUTO-GENERATED apply bundle: migrations 5-5 (run this whole file once in Supabase SQL Editor)

-- ===================== 0005_enum_additions.sql =====================
-- =============================================================================
-- SEKONDMENT â€” 0005a  ENUM ADDITIONS (must run & commit BEFORE 0005)
