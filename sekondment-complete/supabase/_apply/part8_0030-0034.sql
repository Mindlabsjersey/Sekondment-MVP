-- Apply in Supabase Dashboard -> SQL Editor (HTTPS, no Postgres port needed).
-- 0030 taxonomy, 0031 commission, 0032 concierge, 0033 employee deployment, 0034 logos bucket.
