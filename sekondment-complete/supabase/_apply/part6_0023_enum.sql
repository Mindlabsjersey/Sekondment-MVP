-- AUTO-GENERATED apply bundle: migrations 23-23 (run this whole file once in Supabase SQL Editor)

-- ===================== 0023_expertise_graph_expansion.sql =====================
-- =============================================================================
-- SEKONDMENT â€” 0023  EXPERTISE GRAPH EXPANSION (Prompt 5)
...
-- view for marketplace intelligence. No AI here â€” structured data only.
-- =============================================================================

-- â”€â”€ New taxonomy types (jurisdiction, service_category, platform) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
